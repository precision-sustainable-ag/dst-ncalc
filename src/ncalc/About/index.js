  ...
  return (
    <div className="about">
      ...
      <p>
        ...
        The <strong>Cover Crop N Calculator</strong> provides a user-friendly approach to estimate decay of cover crop residues and release of N for offsetting N fertilizer inputs.

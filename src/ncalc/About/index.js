...
const About = () => (
  <div className="about">
    ...
    <p>
      ...
      Data from controlled laboratory experiments and on-farm cover crop decomposition studies across
      diverse environments were used in its development.
      Depending on residue placement, the calculator uses soil moisture and soil temperature (for incorporated residues) or
      residue water potential and air temperature (for surface residues) to adjust decomposition rates.
    </p>
    ...
    <ul>
      <li>
        ...
        <a target="_blank" rel="noreferrer" href="https://api.precisionsustainableag.org/ssurgo">SSURGO</a>
        ),
      </li>
      <li>
      ...
      <li>
        ...
        <a target="_blank" rel="noreferrer" href="https://api.precisionsustainableag.org/weather">weather API</a>
        {' '}

...
const CoverCrops = () => {
  ...
  return (
    <Input
      ...
      autoFocus
      groupBy={(option) =>
        species.Brassica.includes(option)
          ? "Brassica"
          : species.Broadleaf.includes(option)
          ? "Broadleaf"
          : species.Grass.includes(option)
          ? "Grass"
          : species.Legume.includes(option)
          ? "Legume"
          : "ERROR"
      }
      options={[
    ...
    >
      <div className="cover-crop-div">
        ...
        <div className="inputs">
          ...
          <div>
            ...
            <Help>
              ...
              <p>
                ...
                representative sub-sample for quality analysis, please refer to{" "}
                <a
                  tabIndex="-1"
                  target="_blank"
                  rel="noreferrer"
                  href="https://extension.uga.edu/publications/detail.html?number=C1077"
                >
                  here
                </a>
                .
          ...
          <Myslider id="freshBiomass" min={0} max={freshMax} />
      ...
      <div className="bn">
        ...
        <Link className="link" to={"/covercrop2"}>
          NEXT
        </Link>
      </div>
    </div>
    ...
    >
      <div className="cover-crop-div">
        ...
        <div className="inputs">
          ...
          <Myslider id="N" min={0} max={6} step={0.1} />
          <p />
          ...
          <div>
            ...
            <Help>
              ...
              <p>
                carbohydrates (%) = % crude protein (CP) + % fat + % non-fibrous
                carbohydrates (NFC)
              </p>
            </Help>
            :
          ...
          <p />
          <Myslider id="carb" min={20} max={70} step={0.1} />
          ...
          <div>
            ...
            <Help>
              ...
              <p>
                holo-cellulose (%) = % neutral detergent fiber (NDF) – (% lignin
                + % ash)
              </p>
            </Help>
            :
          ...
          <p />
          <Myslider id="cell" min={20} max={70} step={0.1} />
          ...
          <p />
          <Myslider id="lign" min={1} max={10} step={0.1} />
        </div>
      </div>

      <div className="bn">
        <Link className="link" to={"/covercrop"}>
          BACK
        </Link>

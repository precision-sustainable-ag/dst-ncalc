  ...
  return (
    <>
      <div className={className}>
        ...
        <p>
          This calculator aids farmers with decision support regarding cover
          crop residue persistence, as well as the amount and timing of nitrogen
          availability.
        </p>
      ...
      <div>
        ...
        {privacy && (
          <div id="PrivacyPolicy">
            ...
            <p>
              If you enter a fieldname, you can select it from the upper-right
              drop down list the next time you run the program.
            </p>
            <p>

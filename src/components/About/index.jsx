...
import { PSAFigmaButton, PSAModal } from 'shared-react-components/src';
        ...
        <Paper>
          ...
          >
            ...
            <Typography id="modal-modal-title" variant="body1" component="h2">
              Cover crops influence nitrogen (N) management to subsequent cash crops. Some of the N taken up or fixed by the cover crops becomes
              available over the cash crop growing season following termination. Estimating the rate of N release is challenging. The
              <strong> Cover Crop N Calculator </strong>
              provides a user-friendly approach to estimate decay of cover crop residues and release of N for offsetting N fertilizer inputs. This
              tool was developed for farmers and agricultural professionals.
            </Typography>
            <Typography id="modal-modal-title" variant="body1" component="h2">
              The N calculator is adapted from the original CERES-N (N subroutine of the Crop Environment REsource Synthesis) sub-model. Data from
              controlled laboratory experiments and on-farm cover crop decomposition studies across diverse environments were used in its development.
            ...
            <List sx={{ p: 0 }}>
              <BullettedText>
                <Typography variant="body1" component="p">
                  ...
                  <a target="_blank" rel="noreferrer" href="https://ssurgo.covercrop-data.org/">
                    (SSURGO),
                  </a>
                </Typography>
              </BullettedText>
              <BullettedText>
                <Typography variant="body1" component="p">
                  ...
                  <a target="_blank" rel="noreferrer" href="https://docs.clearag.com/documentation/Soil_Conditions/Soil_Conditions/latest">
                    Iteris,
                  </a>
                  and
                </Typography>
              ...
              <BullettedText>
                <Typography variant="body1" component="p">
                  ...
                  <a target="_blank" rel="noreferrer" href="https://weather.covercrop-data.org/">
                    weather API
                  </a>
            ...
            <Typography sx={{ paddingY: '0.7rem' }} id="modal-modal-title" variant="body1" component="h6">
              If these data are unavailable, the program will estimate cover crop residue chemistry based on N concentrations and will use a default
              value for cover crop water content at termination.
            </Typography>
            <Typography sx={{ paddingY: '0.7rem', fontWeight: 'bold' }} id="modal-modal-title" variant="body1" component="h6">
              <strong>
                <em>CC-NCALC uses real-time weather data and five year historic averages for days where data are not yet available.</em>
              </strong>
            </Typography>
            <Box
              sx={{

...
import initRasterObject from './response.json';

// const val = JSON.parse(sampleBiomassData.task_result.replace(/\bNaN\b/g, 'null'));
// const initRasterObject = { data_array: val.data_array[0], bbox: val.bbox };
console.log(initRasterObject);

// const initLon = -101.6838
// const initLat = 41.0686
